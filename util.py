...
def license_complies_format(text):
    ...
    if (text[0] in string.ascii_uppercase or text[0] in dict_int_to_char.keys()) and \
       ...
       (text[8] in string.ascii_uppercase or text[5] in dict_int_to_char.keys()) and \
       (text[9] in string.ascii_uppercase or text[6] in dict_int_to_char.keys()):
        return True
    else:
        return False
...
def read_license_plate(license_plate_crop):
    ...
    text = ocr.ocr(license_plate_crop, cls=True)
    print('jkl',text)
    if text!=[None]:
...
def get_car(license_plate, vehicle_track_ids):
    ...
    for j in range(len(vehicle_track_ids)):
        xcar1, ycar1, xcar2, ycar2, car_id ,class_id= vehicle_track_ids[j]
